<template>
  <div class="work-page">
    <div class="app__img work-page__img">
      <div class="app__content work-page__content">
        ...
        <div class="work-page__staff pull-right"></div>
      </div>
    </div>
  </div>
</template>
...
<style>
  .work-page__img {
    height: 700px;
    padding-top: 1px;
    background-image: url('https://img.yzcdn.cn/public_files/2017/04/16/99dbb97fae05e08c8fe5ea7e804a308c.jpg');
  }
  ...
  .work-page__staff {
    ...
    background-image: url('https://img.yzcdn.cn/public_files/2017/04/17/795d643ca8cc9ccd3df88694bc9edb17.jpg');
    border-radius: 130px;
    width: 400px;
    height: 300px;
    margin-top: 60px;
